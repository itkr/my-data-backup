...
例:
  ...
  python main.py cli move --help               # Move CLIのヘルプ
    ...
    gui_parser.add_argument('--theme', choices=['auto', 'light', 'dark'], 
                           default='auto', help='UIテーマ')
    ...
    move_parser.add_argument('--import-dir', required=True, help='インポートディレクトリ')
    move_parser.add_argument('--export-dir', required=True, help='エクスポートディレクトリ')
