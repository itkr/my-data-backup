...
class ConfiguredUnifiedApp:
    """
    統一データバックアップアプリケーション - 設定管理対応版
    """
    ...
    def __init__(self):
        ...
        # ロガー初期化
        self.logger = get_logger("ConfiguredUnifiedGUI")
...
"""
    ...
    def run(self):
        ...
        self.log_message("📋 統合GUIアプリケーション（設定管理対応版）へようこそ！")
        self.root.mainloop()


if __name__ == "__main__":
    app = ConfiguredUnifiedApp()
    app.run()
